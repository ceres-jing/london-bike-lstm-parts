...
class STGCN(torch.nn.Module):
    ...
    def __init__(self, n_temporal_dim, n_spatial_dim, n_input_channels,
        ...
        #assert n_temporal_dim - 3 * time_conv_length + 4 == 0
    ...
    def forward(self, data_graph):
        ...
        data_step_1 = Data(data_step_0_x, edge_index, edge_attr)
        data_step_2_x = self.model_s_1(data_step_1)
        #data_step_3_x = self.model_t_1b(data_step_2_x)
        data_step_3_x = self._compute_layer_norm(data_step_2_x, self.layer_norm_1)
        ...
        data_out_reshape = data_step_3_x.reshape(self.n_graphs_in_batch, self.n_spatial * self.co_temporal)
